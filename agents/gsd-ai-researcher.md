...
tools: read_file, write_file, run_shell_command, grep_search, glob, web_fetch, web_search, mcp__context7__*
color: "#34D399"
# hooks:
#   PostToolUse:
...
write_file Sections 3–4b of AI-SPEC.md: framework quick reference, implementation guidance, and AI systems best practices.
</role>
...
<required_reading>
read_file `~/.qwen/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
...
Use context7 MCP first (fastest). Fall back to web_fetch.
...
**4b.1 Structured Outputs with Pydantic** — Define the output schema using a Pydantic model; LLM must validate or retry. write_file for this specific `framework` + `system_type`:
