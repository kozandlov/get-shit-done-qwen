...
- read_file the ROADMAP.md phase description and any prior CONTEXT.md files
- Search the codebase for files related to the phase (components, patterns, similar features)
- read_file 5-15 most relevant source files
...
<process>
1. read_file ROADMAP.md and extract the phase description
2. read_file any prior CONTEXT.md files from earlier phases (find via `find .planning/phases -name "*-CONTEXT.md"`)
3. Use glob and grep_search to find files related to the phase goal terms
4. read_file 5-15 most relevant source files to understand existing patterns
...
- Do NOT use web search or external tools (you have read_file, run_shell_command, grep_search, glob only)
