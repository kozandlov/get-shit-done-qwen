...
tools: read_file, write_file, run_shell_command, grep_search, glob, web_search, web_fetch, mcp__context7__*
color: "#A78BFA"
# hooks:
#   PostToolUse:
...
Research the business domain — not the technical framework. write_file Section 1b of AI-SPEC.md.
</role>
...
<required_reading>
read_file `~/.qwen/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
...
read_file AI-SPEC.md, CONTEXT.md, REQUIREMENTS.md. Extract: industry vertical, user population, stakes level, output type.
