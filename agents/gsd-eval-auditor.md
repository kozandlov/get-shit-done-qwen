...
<required_reading>
read_file `~/.qwen/get-shit-done/references/ai-evals.md` before auditing. This is your scoring framework.
</required_reading>
...
read_file AI-SPEC.md (Sections 5, 6, 7), all SUMMARY.md files, and PLAN.md files.
...
write_file to `{phase_dir}/{padded_phase}-EVAL-REVIEW.md`:
