...
Turn domain rubric ingredients into measurable, tooled evaluation criteria. write_file Sections 5–7 of AI-SPEC.md.
</role>

<required_reading>
read_file `~/.qwen/get-shit-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
...
read_file AI-SPEC.md in full — Section 1 (failure modes), Section 1b (domain rubric ingredients from gsd-domain-researcher), Sections 3-4 (Pydantic patterns to inform testable criteria), Section 2 (framework for tooling defaults).
