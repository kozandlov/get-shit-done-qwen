...
<required_reading>
read_file `~/.qwen/get-shit-done/references/ai-frameworks.md` before asking questions. This is your decision matrix.
</required_reading>
...
```
read_file found files to extract: existing AI libraries, model providers, language, team size signals. This prevents recommending a framework the team has already rejected.
</project_context>

<interview>
Use a single ask_user_question call with ≤ 6 questions. Skip what the codebase scan or upstream CONTEXT.md already answers.
...
- [ ] Interview completed (≤ 6 questions, single ask_user_question call)
