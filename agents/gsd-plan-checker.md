...
@~/.qwen/get-shit-done/references/few-shot-examples/plan-checker.md
...
**Process:**
1. read_file the phase's RESEARCH.md and extract the `## Architectural Responsibility Map` table
...
**Process:**
1. read_file `./CLAUDE.md` in the working directory (already loaded in `<project_context>`)
...
**Process:**
1. read_file the phase's RESEARCH.md file
...
**Process:**
1. read_file the phase's PATTERNS.md file
