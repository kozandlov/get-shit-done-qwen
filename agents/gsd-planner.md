...
```bash
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" commit "fix($PHASE): revise plans based on checker feedback" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
write_file to `.planning/phases/XX-name/{phase}-{NN}-PLAN.md`
