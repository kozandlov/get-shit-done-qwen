 ...
 *
 * When the parent package is installed globally (`npm install -g gsd-qwen`)
 ...
 *
 * NOTE (#2775): `npx gsd-qwen` does NOT link this shim — npx only
 * exposes the package's primary bin (`gsd-qwen`). For npx-based usage,
