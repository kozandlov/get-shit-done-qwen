...
<process>
read_file and execute the forensics workflow from @~/.qwen/get-shit-done/workflows/forensics.md end-to-end.
</process>
...
<critical_rules>
- **read_file-only investigation:** Do not modify project source files during forensics. Only write the forensic report and update STATE.md session tracking.
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-forensics ~/.qwen/skills/gsd-forensics
