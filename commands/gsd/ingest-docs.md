...
<execution_context>
@~/.qwen/get-shit-done/workflows/ingest-docs.md
@~/.qwen/get-shit-done/references/ui-brand.md
@~/.qwen/get-shit-done/references/gate-prompts.md
@~/.qwen/get-shit-done/references/doc-conflict-engine.md
</execution_context>
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-ingest-docs ~/.qwen/skills/gsd-ingest-docs
