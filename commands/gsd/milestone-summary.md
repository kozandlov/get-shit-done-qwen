...
<process>
read_file and execute the milestone-summary workflow from @~/.qwen/get-shit-done/workflows/milestone-summary.md end-to-end.
</process>
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-milestone-summary ~/.qwen/skills/gsd-milestone-summary
