...
- If it is `--wrap-up`: strip the flag, execute the sketch-wrap-up workflow from @~/.qwen/get-shit-done/workflows/sketch-wrap-up.md end-to-end.
- Otherwise: execute the sketch workflow from @~/.qwen/get-shit-done/workflows/sketch.md end-to-end.
