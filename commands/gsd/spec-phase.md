...
<execution_context>
@~/.qwen/get-shit-done/workflows/spec-phase.md
@~/.qwen/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @~/.qwen/get-shit-done/workflows/spec-phase.md end-to-end.

**MANDATORY:** read_file the workflow file BEFORE taking any action. The workflow contains the complete step-by-step process including the Socratic interview loop, ambiguity scoring gate, and SPEC.md generation. Do not improvise from the objective summary above.
</process>
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-spec-phase ~/.qwen/skills/gsd-spec-phase
