...
function loadConfig(cwd) {
  ...
  try {
    ...
    return {
      ...
      claude_md_assembly: parsed.qwen_md_assembly || null,
    };
  } catch {
...
/**
 * read_file a phase directory and return counts/flags for common file types.
...
/**
 * read_file immediate child directories from a path.
...
/**
 * write_file a file atomically using write-to-temp-then-rename.
 *
