...
- **Lifecycle**: Created at plan completion → read_file by subsequent plans in same phase
...
- **Lifecycle**: Created at discussion time → read_file-only audit record
...
- **Location**: `~/.qwen/get-shit-done/USER-PROFILE.md`
