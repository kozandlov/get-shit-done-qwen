...
| "chat" or "messaging" | Message history and search? Typing indicators? read_file receipts? |
...
| "scale" or "performance" | read_file/write ratio? read_file replicas? Connection pooling strategy? |
