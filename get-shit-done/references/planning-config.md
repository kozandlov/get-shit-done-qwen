...
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" commit "docs: update state" --files .planning/STATE.md
...
| `workflow.text_mode` | boolean | `false` | `true`, `false` | Use plain-text numbered lists instead of ask_user_question menus |
