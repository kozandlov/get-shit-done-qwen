...
read_file `.planning/ROADMAP.md`. If it does not exist, error: "No ROADMAP.md found — run `/gsd-new-project` first."
...
read_file each phase's scope/goal for these patterns:
...
- **yes** — write_file all suggested `Depends on` entries to ROADMAP.md. Confirm each write.
