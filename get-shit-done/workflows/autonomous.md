...
> Full instructions are in `get-shit-done/references/autonomous-smart-discuss.md`. read_file that file now and follow it exactly.
...
read_file and execute: `$HOME/.qwen/get-shit-done/references/autonomous-smart-discuss.md`
