...
read_file the todo file completely. Display:
...
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/completed/[filename] .planning/STATE.md
```
