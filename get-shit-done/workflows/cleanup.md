...
read_file `.planning/MILESTONES.md` to identify completed milestones and their versions.
...
ask_user_question: "Proceed with archiving?" with options: "Yes — archive listed phases" | "Cancel"
...
```bash
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
