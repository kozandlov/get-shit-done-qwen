...
3. read_file the phase goal from ROADMAP.md
...
write_file a self-contained HTML companion file to:
...
1. read_file `{phase_dir}/{padded_phase}-QUESTIONS.json`
2. Recalculate stats: count answered, chat_more, remaining
3. write_file updated stats back to the JSON
...
1. read_file all currently answered questions from JSON
...
5. write_file CONTEXT.md using the standard context template format:
