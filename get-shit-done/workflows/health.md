...
```bash
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" validate health
```
