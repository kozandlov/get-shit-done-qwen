...
**If seed files exist:** read_file each `SEED-*.md` file and extract from its frontmatter and body:
...
read_file the approved ROADMAP.md and extract the phase list: phase number, phase name, goal, and requirement IDs.
