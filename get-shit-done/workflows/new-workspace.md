...
```bash
INIT=$(node "$HOME/.qwen/get-shit-done/bin/gsd-tools.cjs" init new-workspace)
...
## 7. write_file WORKSPACE.md

write_file the workspace manifest at `$TARGET_PATH/WORKSPACE.md`:
