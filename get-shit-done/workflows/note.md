<purpose>
Zero-friction idea capture. One write_file call, one confirmation line. No questions, no prompts.
...
5. write_file the file with frontmatter and note text (see storage format)
