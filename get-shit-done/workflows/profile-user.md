...
- @$HOME/.qwen/agents/gsd-user-profiler.md (profiler agent definition)
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/.qwen/skills/gsd-dev-preferences/SKILL.md"
...
**Error handling:** If any `gsd-sdk query` or gsd-tools.cjs call fails, display the error message and use ask_user_question to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.qwen/skills/gsd-dev-preferences/SKILL.md
