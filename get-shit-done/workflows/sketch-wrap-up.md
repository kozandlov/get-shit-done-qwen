...
1. read_file `.planning/sketches/MANIFEST.md` for the design direction and reference points
...
1. read_file all included sketches' tags, names, and content
...
write_file `.planning/sketches/WRAP-UP-SUMMARY.md` for project history:
