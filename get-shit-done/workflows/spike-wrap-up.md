...
1. read_file `.planning/spikes/MANIFEST.md` for the overall idea context
...
**If "Help me UAT this":**
1. read_file the spike's README "How to Run" and "What to Expect" sections
...
1. read_file all included spikes' tags, names, `related` fields, and content
...
## write_file Planning Summary

write_file `.planning/spikes/WRAP-UP-SUMMARY.md` for project history:
