...
1. read_file `.planning/spikes/MANIFEST.md` for the overall idea context and requirements
...
1. read_file all spike source code and READMEs looking for:
...
2. write_file or update `.planning/spikes/CONVENTIONS.md`:
