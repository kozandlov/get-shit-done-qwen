...
read_file `.planning/.phase-manifest.json` if it exists.
...
read_file `.planning/ROADMAP.md` inline.
...
1. read_file the later plan's PLAN.md
...
- Use ask_user_question with approve-revise-abort pattern:
