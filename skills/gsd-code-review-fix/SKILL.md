...
<execution_context>
@~/.qwen/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @~/.qwen/get-shit-done/workflows/code-review-fix.md end-to-end.
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-code-review-fix ~/.qwen/skills/gsd-code-review-fix
