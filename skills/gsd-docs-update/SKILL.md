...
<execution_context>
@~/.qwen/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @~/.qwen/get-shit-done/workflows/docs-update.md end-to-end.
...
```bash
# Global
ln -s ~/.qwen/get-shit-done/skills/gsd-docs-update ~/.qwen/skills/gsd-docs-update
