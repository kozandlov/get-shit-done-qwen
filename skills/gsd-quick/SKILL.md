...
read_file PLAN.md and SUMMARY.md (if exists) for the given slug. Display:
```
Quick task: {slug}
─────────────────────────────────────
...
3. read_file PLAN.md to extract description and SUMMARY.md (if exists) to extract status.
