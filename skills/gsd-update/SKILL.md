...
- Otherwise: **Follow the update workflow** from `@~/.qwen/get-shit-done/workflows/update.md`.
...
@~/.qwen/get-shit-done/workflows/sync-skills.md
@~/.qwen/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
